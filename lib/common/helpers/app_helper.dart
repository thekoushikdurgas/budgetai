  ...
  static HttpResponseModel checkEmailAndPassword({
    ...
    if (!AppConstants.emailRegex.hasMatch(email)) {
      return HttpResponseModel(
        statusCode: 401,
        message: LocaleKeys.enter_valid_email.tr(),
      );
    }
    if (!AppConstants.passwordRegex.hasMatch(password)) {
      return HttpResponseModel(
        statusCode: 401,
        message: LocaleKeys.enter_valid_password.tr(),
      );
    }
    ...
    showCupertinoDialog(
      ...
      builder: (context) => CupertinoAlertDialog(
        title: title != null
            ...
            : null,
        content:
            content != null ? Text(content, textAlign: TextAlign.start) : null,
        actions: [
  ...
  static Future<void> downloadImage(String url) async {
    try {
      ...
      final File file = File(
        '${documentDirectory.path}/${const Uuid().v1()}.jpg',
      );
